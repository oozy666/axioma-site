const translations = {
    en: {
        "title": "/all by Axioma",
        "lead": "/all by Axioma is a Telegram-based application that helps users automate email outreach by sending emails directly from their own Google accounts.",
        ...
        "auth_desc": "/all by Axioma uses Google OAuth 2.0 and the Gmail API. Emails are sent strictly on behalf of the authenticated user and only after explicit user authorization.",
        ...
        "footer_rights": "2026 /all by Axioma. All rights reserved.",
        ...
        "policy_intro": "This Privacy Policy describes how /all by Axioma (\"the Application\") accesses, uses, stores, and protects user data.",

        "tos_intro": "Welcome to /all by Axioma (\"Service\", \"Application\")! These Terms of Service (\"Terms\") govern your use of our Telegram bot, which provides email automation tools through your own Google account (\"Services\"). Please read them carefully.",
        ...
        "tos_1_text": "/all by Axioma is a tool that allows users to send emails from their Google accounts using the Gmail API and Google Drive API to access recipient lists provided by the user.",
        ...
        "tos_5_limit": "To the maximum extent permitted by law, /all by Axioma, its developers, and owners shall under no circumstances be liable for any indirect, incidental, special, or punitive damages, including but not limited to loss of data, loss of profit, business interruption, or other intangible damage resulting from the use or inability to use the Service.",
        ...
        "section_1_text": "/all by Axioma is a Telegram-based email automation tool that allows users to send emails from their own Google accounts using the Gmail API.",
        ...
        "app_name_value": "/all by Axioma"
    },
    ru: {
        "title": "/all от Axioma",
        "lead": "/all от Axioma — это приложение на базе Telegram, которое помогает автоматизировать email-рассылки, отправляя письма напрямую с вашего Google-аккаунта.",
        ...
        "auth_desc": "/all от Axioma использует Google OAuth 2.0 и Gmail API. Письма отправляются строго от имени авторизованного пользователя и только после его явного разрешения.",
        ...
        "footer_rights": "2026 /all от Axioma. Все права защищены.",
        ...
        "policy_intro": "Настоящая Политика конфиденциальности описывает, как /all от Axioma («Приложение») получает доступ, использует, хранит и защищает данные пользователей.",

        "tos_intro": "Добро пожаловать в /all by Axioma (далее \"Сервис\", \"Приложение\")! Настоящие Условия предоставления услуг (\"Условия\") регулируют использование вами нашего Telegram-бота, который предоставляет инструменты для автоматизации email-рассылок через ваш собственный Google-аккаунт (\"Услуги\"). Пожалуйста, внимательно прочтите их.",
        ...
        "tos_1_text": "/all by Axioma — это инструмент, который позволяет пользователям отправлять электронные письма со своих Google-аккаунтов, используя Gmail API и Google Drive API для доступа к спискам получателей, предоставленным пользователем.",
        ...
        "tos_5_limit": "В максимальной степени, разрешенной законом, /all by Axioma, его разработчики и владельцы ни при каких обстоятельствах не несут ответственности за любые косвенные, случайные, специальные или штрафные убытки, включая, но не ограничиваясь, потерю данных, упущенную выгоду, сбои в работе или другой нематериальный ущерб, возникший в результате использования или невозможности использования Сервиса.",
        ...
        "section_1_text": "/all от Axioma — это инструмент автоматизации электронной почты на базе Telegram, который позволяет пользователям отправлять письма со своих учетных записей Google, используя Gmail API.",
